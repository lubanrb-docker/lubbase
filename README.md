# Uber Lubbase docker image development-1.0.4
...
curl -sSL -o lubbase-development-1.0.4.tar.gz  https://github.com/lubanrb-docker/lubbase/archive/development-1.0.4.tar.gz
```

### Uncompress the tar ball

```
tar -xzf lubbase-development-1.0.4.tar.gz
```
...
```
cd lubbase-development-1.0.4/docker
